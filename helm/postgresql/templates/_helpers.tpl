...
{{- else -}}
    {{- include "getValueFromSecret" (dict "Namespace" .Release.Name "Name" (include "common.names.fullname" .) "Length" 10 "Key" "postgresql-postgres-password")  -}}
{{- end -}}
{{- end -}}
...
{{- else -}}
    {{- include "getValueFromSecret" (dict "Namespace" .Release.Name "Name" (include "common.names.fullname" .) "Length" 10 "Key" "postgresql-password")  -}}
{{- end -}}
{{- end -}}
...
{{- else -}}
    {{- include "getValueFromSecret" (dict "Namespace" .Release.Name "Name" (include "common.names.fullname" .) "Length" 10 "Key" "postgresql-replication-password")  -}}
{{- end -}}
{{- end -}}
